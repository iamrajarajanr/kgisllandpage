        ...
        <div className='bg-black text-white '>
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 justify-items-start pl-8 md:pl-0 gap-32 container mx-auto py-12'>
                <div className=''>
                    ...
                    <p className='text-[#ffffff75] leading-8 py-6'>KGiSL College is committed to delivering quality education, fostering innovation, and preparing students to become leaders of tomorrow.</p>
                    <h2 className='text-2xl pb-2'>kgisl@kgisl.com</h2>
            ...
            <div className='border-t border-[#221F35] flex justify-center items-center py-12'>
                <div className="flex justify-center items-center ">
                    <h2>Copyright © 2025 KGiSL ❤. All rights reserved.</h2>
                </div>
            </div>
        </div>
    )
